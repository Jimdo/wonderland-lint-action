...
func TestService_Activate(t *testing.T) {
	...
	service, mocks := createServiceWithMocks(ctrl)
	mocks.cs.EXPECT().GetByName(cronName).Return(cron, nil)
	mocks.cm.EXPECT().ActivateRule(cron.RuleARN)
...
func TestService_Activate_ErrorToFindCronRule(t *testing.T) {
	...
	service, mocks := createServiceWithMocks(ctrl)
	mocks.cs.EXPECT().GetByName(cronName).Return(nil, errors.New("test-error"))
...
func TestService_Activate_ErrorToActivateCronRule(t *testing.T) {
	...
	service, mocks := createServiceWithMocks(ctrl)
	mocks.cs.EXPECT().GetByName(cronName).Return(cron, nil)
	mocks.cm.EXPECT().ActivateRule(cron.RuleARN).Return(errors.New("test-error"))
...
func TestService_Deactivate(t *testing.T) {
	...
	service, mocks := createServiceWithMocks(ctrl)
	mocks.cs.EXPECT().GetByName(cronName).Return(cron, nil)
	mocks.cm.EXPECT().DeactivateRule(cron.RuleARN)
...
func TestService_Deactivate_ErrorToActivateCronRule(t *testing.T) {
	...
	service, mocks := createServiceWithMocks(ctrl)
	mocks.cs.EXPECT().GetByName(cronName).Return(cron, nil)
	mocks.cm.EXPECT().DeactivateRule(cron.RuleARN).Return(errors.New("test-error"))
