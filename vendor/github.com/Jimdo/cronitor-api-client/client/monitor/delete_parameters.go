...
// WithCode adds the code to the delete params
func (o *DeleteParams) WithCode(code string) *DeleteParams {
	o.SetCode(code)
	return o
}

// SetCode adds the code to the delete params
func (o *DeleteParams) SetCode(code string) {
	o.Code = code
}
