...
// WithCode adds the code to the get params
func (o *GetParams) WithCode(code string) *GetParams {
	o.SetCode(code)
	return o
}

// SetCode adds the code to the get params
func (o *GetParams) SetCode(code string) {
	o.Code = code
}
