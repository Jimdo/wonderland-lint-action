...
// WithPayload adds the payload to the create params
func (o *CreateParams) WithPayload(payload *models.MonitorParams) *CreateParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the create params
func (o *CreateParams) SetPayload(payload *models.MonitorParams) {
	o.Payload = payload
}
