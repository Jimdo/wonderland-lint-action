...
set-credentials:
	WONDERLAND_ENV=$(JIMDO_ENVIRONMENT) \
		wl vault write secret/wonderland/crons \
			WONDERLAND_REGISTRY_USER=$(WONDERLAND_API_USER) \
			WONDERLAND_REGISTRY_PASS=$(WONDERLAND_API_PASS) \
			...
			NOTIFICATIONS_API_USER=$(WONDERLAND_API_USER) \
			NOTIFICATIONS_API_PASS=$(WONDERLAND_API_PASS) \
			ECS_METADATA_USER=$(WONDERLAND_API_USER) \
			ECS_METADATA_PASS=$(WONDERLAND_API_PASS)
